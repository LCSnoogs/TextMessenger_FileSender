...
public class Node extends Observable implements Runnable {
    ...
    public void sendData(int packetIdentifier, int destinationAddress, byte[] data){
    	...
    	// Dr. Byun
    	// String byun_str = new String(data);
		// Log.i("Node", "Node.java: sendData() to " + destinationAddress + ": " + byun_str);
		// Log.i("Sender", " ");
		// Log.i("Sender", "==========================================================================");
		// Log.i("Sender", "Node.java: sendData() to " + destinationAddress + ": " + byun_str);
    }
	...
	/**
	 * Notifies the application layer that the Node received DATA. 
	...
	protected void notifyAboutDataReceived(int senderNodeAddess, byte[] data) {	
		 ...
		 // Dr. Byun
	     // Log.i("UDP", "        Node.java: Notify DATA_RECEIVED from " + senderNodeAddess);
	...
	protected void notifyAboutRouteEstablishmentFailure(int faliedToReachAddress) {
		...
		// Dr. Byun
	    // Log.i("AODVObserver", "Node: Notify ROUTE_ESTABLISHMENT_FAILURE to " + faliedToReachAddress);
	...
	protected void notifyAboutDataSentSucces(int packetIdentifier){
		...
		// Dr. Byun
	    // Log.i("AODVObserver", "Node: Notify DATA_SENT_SUCCESS (Packet ID: " + packetIdentifier + ")");
	...
	protected void notifyAboutInvalidAddressGiven(int packetIdentifier){
		...
		// Dr. Byun
	    // Log.i("AODVObserver", "Node: Notify INVALID_DESTINATION_ADDRESS (Packet ID: " + packetIdentifier + ")");
	...
	protected void notifyAboutSizeLimitExceeded(int packetIdentifier){
		...
		// Dr. Byun
	    // Log.i("AODVObserver", "Node: Notify DATA_SIZE_EXCEEDES_MAX (Packet ID: " + packetIdentifier + ")");
	...
	protected void notifyAboutRouteToDestIsInvalid(int destinationAddress){
		...
		// Dr. Byun
	    // Log.i("AODVObserver", "Node: Notify ROUTE_INVALID to " + destinationAddress);
	...
	protected void notifyAboutNewNodeReachable(int destinationAddress){
		...
		// Dr. Byun
	    // Log.i("AODVObserver", "Node: Notify ROUTE_CREATED to " + destinationAddress);
	...
	/**
	 * This interface defines a structure for an observer to retrieve a message from the observable
	 * @author rabie
	 *
	 */
