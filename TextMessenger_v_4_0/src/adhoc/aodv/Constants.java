...
public interface Constants {
	...
	public static final int MAX_PACKAGE_SIZE = 900000;
	...
	public static final int MAX_NUMBER_OF_RREQ_RETRIES = 1;    // Dr. Byun: Just one-time try. Originally it was 2.
	
	//the amount of time to store a RREQ entry before the entry dies
	public static final int PATH_DESCOVERY_TIME = 2000;       // Dr. Byun: Originally it was 3000.
