...
public class QuitChat implements PduInterface{
	...
	public QuitChat(int chatID){
		this.chatID = chatID;
		pduType = Constants.PDU_QUIT_CHAT;
	}
	...
	public void parseBytes(byte[] dataToParse) throws BadPduFormatException {
		...
		if(s.length != 3){
			throw new BadPduFormatException(	"QuitChat: could not split " +
		...
		try {
			...
			throw new BadPduFormatException("QuitChat: falied parsing arguments to the desired types");
		}
